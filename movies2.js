/**
*** Version 2 of movies program - Short & simple 
**/ 
...
console.log("\nBest movies from the list ----> " + titles(filter(movieList, goodRating)));
console.log("\nAverage rating of Nolan movies ----> " + average(ratings(nolanMovieList)));
